...
#include <string.h>
void main()
{char kdb[5],nmb[10];long hrg,qty,jml;
clrscr();
 //input data
 ...
 gotoxy(5,7);printf("Harga         ");gotoxy(35,7);printf(":");
 gotoxy(5,8);printf("qty        ");gotoxy(35,8);printf(":");
 gotoxy(5,9);printf("Jumlah        ");gotoxy(35,9);printf(":");
 gotoxy(5,10);printf("============================================");
 //input data
 ...
 gotoxy(37,6);printf("%s",nmb);gotoxy(37,7);printf("%i",hrg);
 gotoxy(37,8);scanf("%i",&qty);jml=qty*hrg;gotoxy(37,9);printf("%i",jml);
 getche();}
